...
print(Fore.RED+"Checking all the requirements for running the script 💻")
...
print(Fore.CYAN+"Requirements satisfied. The program has been started successfully ✔");print()
...
print(Fore.RED+"filling email/phone 🔐...")
...
print(Fore.CYAN+"email/phone has been successfully filled ✔")
...
print(Fore.RED+"filling password 🔐...")
...
print(Fore.CYAN+"password has been successfully filled ✔")
...
print(Fore.CYAN+"Login successful ✔");print()

# This is used to for displaying the info about the URL of the user
print(Fore.RED+"opening the given URL 🌍...")
...
print(Fore.CYAN+"URL opened successfully ✔");print()
...
while count<= 1:
    ...
    try:
        ...
        add_to_cart.click()
        count += 2
        print(Fore.GREEN+"Button clicked!!! The item has been added to the cart successfully 🛒");print()
        print("Thank you for using Amazon_AutoBuy 😊.")
        print(Fore.BLACK+"********************** Developed by Mr.Rinku **********************");print()
    # This except statement used to reload the page every second untill the untill the add to cart option is enabled
    except:
        if count <= 1:
            print(Fore.RED+"Button not appeared, reloading...It's reloaded 🔄 "+str(page_refreshed)+" times!")
            driver.refresh()
            page_refreshed += 1
        pass
exit()
